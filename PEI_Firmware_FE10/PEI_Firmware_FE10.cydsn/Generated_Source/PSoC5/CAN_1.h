...
#define CAN_1_TX_MAILBOX_TORQUE_REQUEST_COMMAND (0u)
#define CAN_1_TX_MAILBOX_PEI_CURRENT   (1u)
#define CAN_1_TX_MAILBOX_MC_ESTOP      (2u)
#define CAN_1_TX_MAILBOX_MC_DEBUG      (3u)
...
#define CAN_1_RX_MAILBOX_Torque_Request_Command (0u)
#define CAN_1_RX_MAILBOX_MC_Debug      (1u)
#define CAN_1_RX_MAILBOX_MC_ESTOP      (2u)
#define CAN_1_RX_MAILBOX_BSPD_Flags    (3u)
#define CAN_1_RX_MAILBOX_MC_Fault      (4u)
#define CAN_1_RX_MAILBOX_MC_Voltage    (5u)
