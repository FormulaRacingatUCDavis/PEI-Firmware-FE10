            ...
            if ((CY_GET_REG16((reg16 *) &CAN_1_BUF_SR_REG.byte[0u]) & shift) != 0u)
            {
                if ((CAN_1_RX[mailboxNumber].rxcmd.byte[0u] & CAN_1_RX_INT_ENABLE_MASK) != 0u)
                {
                    if ((CAN_1_RX_MAILBOX_TYPE & shift) != 0u)
                    {
                        ...
                        {
                            case 0u : CAN_1_ReceiveMsgTorque_Request_Command();
                            break;
                            case 1u : CAN_1_ReceiveMsgMC_Debug();
                            break;
                            case 2u : CAN_1_ReceiveMsgMC_ESTOP();
                            break;
                            case 3u : CAN_1_ReceiveMsgBSPD_Flags();
                            break;
                            case 4u : CAN_1_ReceiveMsgMC_Fault();
                            break;
                            case 5u : CAN_1_ReceiveMsgMC_Voltage();
                            break;
                            default:
                            break;
                        }
